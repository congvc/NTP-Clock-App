package com.congvc.ntpclock.view;
...
public class MyAnalogClock extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int availableWidth = point.x/2;
        int availableHeight = point.x/2;
...
//        int y = availableHeight / 2;
		...
		// Draw text date
        canvas.drawText(mDateString, point.x/2, point.y/2, paintText);
        canvas.restore();
	...
	/**
	 * Set time, date and update analog clock view
	 * 
	 * @param hours: the hours display onto view
	 * @param minutes: the minutes display onto view
	 * @param seconds: the seconds display onto view
	 * @param date: the date display onto view
	 */
